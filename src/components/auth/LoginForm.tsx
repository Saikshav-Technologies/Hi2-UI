  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-[380px] md:max-w-[450px] lg:max-w-[650px] h-auto bg-white rounded-[18px] shadow-2xl px-6 py-6 md:px-10 md:py-8 z-10">
        <h2 className="text-xl md:text-2xl font-semibold text-center text-[#37CE62] mb-4 md:mb-6">
          Log In
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
          ...
          <div className="flex items-center justify-between pt-1">
            <div className="flex items-center">
              ...
              <label
                htmlFor="remember-me"
                className="ml-2 block text-[10px] md:text-xs text-gray-700"
              >
                Remember Me
              </label>
            </div>
            <div className="text-[10px] md:text-xs">
              <Link href="/forgot-password" className="text-gray-600 md:hover:text-gray-900">
                Forgot Password?
              </Link>
            </div>
          </div>
