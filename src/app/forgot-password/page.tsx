...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        // Store email in localStorage for the next page
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="space-y-3">
                  <h1 className="text-[#131c61] text-[32px] md:text-[40px] leading-tight">
                    Recover your <span className="font-semibold text-[#37CE62]">account.</span>
                  </h1>
                  <p className="text-[#9ca3af] text-[16px] leading-relaxed max-w-[360px]">
                    Don't worry! It happens to the best of us. Let's get you back into your
                    community.
                  </p>
                </div>
          ...
          <div className="flex-1 bg-white p-6 md:p-8 flex flex-col justify-center">
            <div className="max-w-[400px] mx-auto w-full space-y-5">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {/* Email Input */}
                <div className="space-y-2">
                  <label htmlFor="email" className="text-[#131c61] text-[14px] font-medium block">
                    Email Address
                  </label>
                  <input
                    id="email"
