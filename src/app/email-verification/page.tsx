            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="space-y-4">
                <h1 className="text-[#131c61] text-[40px] md:text-[48px] font-bold leading-tight">
                  Verify your .<div className="text-[#37CE62]">email</div>
                </h1>
                <p className="text-[#9ca3af] text-[16px] leading-relaxed max-w-[360px]">
                  We've sent a 6-digit verification code to your email address. Please enter it to
                  secure your account.
                </p>
              </div>
            </div>
          ...
          <div className="flex-1 bg-white p-8 md:p-12 flex flex-col justify-center">
            <div className="max-w-[400px] mx-auto w-full space-y-8">
              ...
              <button
                ...
                disabled={isLoading}
                className="w-full rounded-[24px] border border-[#131C61] h-[56px] text-[#131C61] text-[16px] font-bold rounded-full transition-all shadow-lg hover:shadow-xl active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
              ...
              <div className="text-center pt-4">
                <Link
                  href="/login"
                  className="text-[#9ca3af] text-[14px] hover:text-[#131c61] transition-colors inline-flex items-center gap-2"
                >
                  <svg
                    width="16"
                    height="16"
...
function OTPInput({ otp, setOtp }: { otp: string[]; setOtp: (otp: string[]) => void }) {
